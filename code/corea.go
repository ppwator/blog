...
func main() {
	...
	c.OnHTML(`a.collection-product-card`, func(e *colly.HTMLElement) {
		...
		fmt.Println("courseURL:", courseURL)
	...
	err = c.Visit("https://coursera.org/browse")
	if err != nil {
